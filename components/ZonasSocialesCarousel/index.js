...
return (
    <section className='ZonasSocialesCarousel'>
        ...
        >
            <SwiperSlide>
            <img src="images/Zonas_Sociales_Ventum-01.jpg" alt="nature-1"/>
            ...
            <SwiperSlide>
            <img src="images/Zonas_Sociales_Ventum-03.jpg" alt="nature-3"/>
            <div className='copy even'>
            ...
            <SwiperSlide>
            <img src="images/Zonas_Sociales_Ventum-04.jpeg" alt="nature-4"/>
            <div className='copy odd'>
            ...
            <SwiperSlide>
            <img src="images/Zonas_Sociales_Ventum-05.jpeg" alt="nature-5"/>
            <div className='copy even'>
                <h2>PLAYGROUND</h2>
                <p>Culpa ipsum consequat do et ea tempor non labore consequat anim exercitation id sunt ad.</p>
            </div>
